...
export default function Navbar() {
  ...
  return (
    <AnimatePresence>
      <motion.div
        className={`px-4 hav md:px-[39px] bg-transparent backdrop-blur-sm max-w-[1512px] text-black mx-auto py-[16px] fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled ? 'backdrop-blur-xs shadow-md py-[12px]' : ' pt-[32px]'
        }`}
        initial="visible"
